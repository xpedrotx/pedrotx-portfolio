      ...
      <div className="relative z-10 bg-background/70 backdrop-blur-md flex-1 flex flex-col w-full">
        <main className="flex-1 pt-28 sm:pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full space-y-6">
          ...
          <motion.div
            ...
            className="relative w-full h-162 sm:h-225 rounded-3xl overflow-hidden border border-border/60 bg-background/75 shadow-2xl backdrop-blur-xl"
          >
            <object
              key={key}
              ...
              aria-label="Pedro Teixeira Resume PDF"
            >
              <iframe
                src={`${RESUME_PATH}#toolbar=1&navpanes=0&scrollbar=1`}
                className="w-full h-full border-0"
                title="Pedro Teixeira Resume PDF"
              >
