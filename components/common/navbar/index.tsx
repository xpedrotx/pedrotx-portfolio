    ...
    >
      <div
        className={cn(
          ...
          isScrolled ? "shadow-xl border-primary/20 bg-background/75" : "shadow-lg"
        )}
      >
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className={cn(mono.className, "text-primary text-lg font-semibold tracking-tight")}>
              {profile.name.brand.toUpperCase()}
            </span>
          </Link>
