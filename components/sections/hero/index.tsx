...
export const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      ref={containerRef}
      className="relative flex flex-col min-h-screen w-full items-center justify-center bg-transparent text-primary overflow-hidden"
    >
      <motion.main
      ...
      >
        ...
        >
          <RotatingTextHero
            constant_word={t("constant")}
            rotating_words={t.raw("rotating") as string[]}
          />
        </motion.div>
      </motion.main>
    </section>
